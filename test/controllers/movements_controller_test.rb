...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference("Movement.count") do
      post movements_url, params: { movement: { amount: @movement.amount, concept: @movement.concept, date: @movement.date, description: @movement.description, unit_id: @movement.unit_id, user_id: @movement.user_id } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { amount: @movement.amount, concept: @movement.concept, date: @movement.date, description: @movement.description, unit_id: @movement.unit_id, user_id: @movement.user_id } }
